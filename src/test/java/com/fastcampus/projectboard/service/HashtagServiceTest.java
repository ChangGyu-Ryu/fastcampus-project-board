...
class HashtagServiceTest {
    ...
    @DisplayName("본문을 파싱하면, 해시태그 이름들을 중복없이 변환한다.")
    @MethodSource
    @ParameterizedTest(name = "[{index}] \"{0}\" => {1}")
    void giveContent_whenParing_thenReturnUniqueHashtagNames(String input, Set<String> expected) {
        //Given
    ...
    static Stream<Arguments> giveContent_whenParing_thenReturnUniqueHashtagNames() {
        return Stream.of(
